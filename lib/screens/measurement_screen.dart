...
class _MeasurementScreenState extends State<MeasurementScreen> {
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Image.asset(
                    ...
                    fit: BoxFit.contain,
                    errorBuilder: (c, o, s) => const Icon(Icons.touch_app,
                ...
                child: Column(
                  ...
                  children: [
                    FittedBox(
                      ...
                      child: Text(
                        kgValue.toStringAsFixed(
                            2), // Tampilkan 2 desimal (presisi timbangan)
                ...
                children: [
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      icon: Icon(_isMeasuring ? Icons.save : Icons.play_arrow,
                          color: Colors.white),
                      label: Text(
            ...
            child: Row(
              ...
              children: [
                _buildStatusIndicator(
                  ...
                  color:
                      glove.isConnected ? Colors.greenAccent : Colors.redAccent,
                  icon: glove.isConnected
                      ? Icons.scale
                      : Icons.bluetooth_searching, // Ikon Timbangan
                ),
                _buildStatusIndicator(
                    label: "Tare: Auto",
  ...
  Future<void> _saveToDatabase(double value) async {
    ...
    if (value > 30)
      status = "Strong"; // Threshold disesuaikan utk load cell
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text("Data ${value.toStringAsFixed(2)}kg saved successfully!"),
